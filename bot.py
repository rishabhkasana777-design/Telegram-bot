...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "joined":
        await query.message.reply_text("🔒 Activation required. Complete registration first.")
    elif query.data == "proof":
        await query.message.reply_text("📩 Send screenshot of your deposit")
